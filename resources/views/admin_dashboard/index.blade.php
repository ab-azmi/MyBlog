...
@section("style")
    <link href="{{asset('admin_dashboard_asset/plugins/vectormap/jquery-jvectormap-2.0.2.css')}}" rel="stylesheet"/>
@endsection
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle mb-0">
                            ...
                            <tbody><tr>
                                <td>Iphone 5</td>
                                <td><img src="{{asset('admin_dashboard_asset/images/products/01.png')}}" class="product-img-2" alt="product img"></td>
                                <td>#9405822</td>
                            ...
                            <tr>
                                <td>Earphone GL</td>
                                <td><img src="{{asset('admin_dashboard_asset/images/products/02.png')}}" class="product-img-2" alt="product img"></td>
                                <td>#8304620</td>
                            ...
                            <tr>
                                ...
                                <td><img src="{{asset('admin_dashboard_asset/images/products/03.png')}}" class="product-img-2" alt="product img"></td>
                                <td>#4736890</td>
                            ...
                            <tr>
                                <td>Clasic Shoes</td>
                                <td><img src="{{asset('admin_dashboard_asset/images/products/04.png')}}" class="product-img-2" alt="product img"></td>
                                <td>#8543765</td>
                                <td><span class="badge bg-gradient-quepal text-white shadow-sm w-100">Paid</span></td>
                                <td>$1200.00</td>
                                <td>14 Feb 2020</td>
                            ...
                            <tr>
                                <td>Sitting Chair</td>
                                <td><img src="{{asset('admin_dashboard_asset/images/products/06.png')}}" class="product-img-2" alt="product img"></td>
                                <td>#9629240</td>
                                <td><span class="badge bg-gradient-blooker text-white shadow-sm w-100">Pending</span></td>
                                <td>$1500.00</td>
                                <td>18 Feb 2020</td>
                            ...
                            <tr>
                                <td>Hand Watch</td>
                                <td><img src="{{asset('admin_dashboard_asset/images/products/05.png')}}" class="product-img-2" alt="product img"></td>
                                <td>#8506790</td>
                                <td><span class="badge bg-gradient-bloody text-white shadow-sm w-100">Failed</span></td>
                                <td>$1800.00</td>
                                <td>21 Feb 2020</td>
...
@section("script")
    <script src="{{asset('admin_dashboard_asset/plugins/vectormap/jquery-jvectormap-2.0.2.min.js')}}"></script>
    <script src="{{asset('admin_dashboard_asset/plugins/vectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
    <script src="{{asset('admin_dashboard_asset/plugins/chartjs/js/Chart.min.js')}}"></script>
    <script src="{{asset('admin_dashboard_asset/plugins/chartjs/js/Chart.extension.js')}}"></script>
    <script src="{{asset('admin_dashboard_asset/plugins/jquery.easy-pie-chart/jquery.easypiechart.min.js')}}"></script>
    <script src="{{asset('admin_dashboard_asset/js/index.js')}}"></script>
@endsection
