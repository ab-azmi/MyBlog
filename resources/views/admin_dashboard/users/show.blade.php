            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{$user->name}} Posts</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div
                                        class="badge rounded-pill {{($post->status === 'published') ? 'text-success bg-light-success' : 'text-warning bg-light-warning'}} p-2 text-uppercase px-3">
