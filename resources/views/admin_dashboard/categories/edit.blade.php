    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                            ...
                            <div class="col-lg-12">
                                <div class="border border-3 p-4 rounded">
                                    <div class="mb-3">
                                        ...
                                        <input required type="text" name="name" value="{{old('name', $category->name)}}"
                                    ...
                                    <a href="#" onclick="event.preventDefault(); document.querySelector('#delete_form_{{$category->id}}').submit()"
                ...
                <form id="delete_form_{{$category->id}}" method="post" action="{{route('admin.categories.destroy', $category)}}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
