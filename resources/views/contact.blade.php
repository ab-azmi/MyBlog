...
@section('content')
<div class="global-message global-message-info d-none"></div>
            ...
            <div class="col-md-6">
                <form autocomplete="off" method="POST" onsubmit="return false;">
                    ...
                    <div class="row form-group">
                        <div class="col-md-6">
                            <x-blog.form.input value="{{old('first_name')}}" name="first_name"
                                placeholder="Your first name" />
                                <small class="error text-danger first_name"></small>
                        </div>
                        <div class="col-md-6">
                            <x-blog.form.input value="{{old('last_name')}}" name="last_name"
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            <x-blog.form.input value="{{old('email')}}" type="email" name="email"
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            <x-blog.form.textarea value="{{old('message')}}" name="message"
